    ...
    es: {
        ...
        how: {
            hero: {
                ...
                body: "Kickoff 18:00 ET (Toronto). Tema + open build + twist opcional. No traigas una app ya hecha. Boilerplates s\u00ed.",
                primary: "Entrar al ring",
            ...
            steps: {
                ...
                items: [
                    ...
                    },
                    {
                        num: "02",
                        title: "Constru\u00eds",
                        body: "Ten\u00e9s 2 horas. Cualquier stack. Cualquier IA. Cualquier template. Objetivo: shippear."
                    },
                    {
                        num: "03",
                        title: "Entreg\u00e1s demo",
    ...
    en: {
        ...
        how: {
            hero: {
                ...
                body: "Kickoff 18:00 ET (Toronto). Theme + open build + optional twist. Boilerplates ok. No pre-built products.",
                primary: "Enter the ring",
            ...
            steps: {
                ...
                items: [
                    ...
                    },
                    {
                        num: "02",
                        title: "Build",
                        body: "You get 2 hours. Any stack. Any AI. Any template. Goal is shipping."
                    },
                    {
                        num: "03",
                        title: "Ship the demo",
