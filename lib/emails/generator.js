...
// Initialized lazily inside the function
...
export async function generateEmailContent(subscriber, dropInfo) {
    try {
        if (!process.env.GROQ_API_KEY) {
            ...
            return `<h1>Welcome to Vibe Arena, ${subscriber.name}</h1><p>Thanks for joining.</p>`;
        }
        ...
        const context = {
            ...
            dropName: dropInfo ? dropInfo.name : 'Coming Soon',
